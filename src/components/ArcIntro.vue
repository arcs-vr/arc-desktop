<template v-once>
    <div class="intro">
        <div class="column">
            ...
            <div class="section">
                <p class="paragraph">
                    <strong>Start interacting</strong> with the experience on your smartphone or computer <strong>from this
                    device</strong>.
                </p>
            </div>
        </div>
        <div class="column">
            <div class="section">
                <p>
                    ...
                    <router-link :to="{ name: $arcOptions.routeApp }"
                                 v-text="appUrl"
                    />
                </p>
            </div>
            <div class="section">
                <p>
                    ...
                    <span>
                    (
                    <img alt="Game controller symbol"
                         class="icon"
                ...
                <qr-code :options="{ color: {dark: themeColors['dark'], light: themeColors['secondary']}, width: 300}"
                         :value="deviceName"
                         class="qr-code"
                />
            </div>
