    ...
    <arc-remote ref="remote">
        <div class="column">
            ...
            <div class="keyboard-hints">
                <div class="key-row">
                    <div :class="{'pressed': keys.hasOwnProperty('w') || keys.hasOwnProperty('ArrowUp')}"
                         class="key key-w"
                    >
                        W&nbsp;/&nbsp;&uparrow;
                    </div>
                ...
                <div class="key-row">
                    <div :class="{'pressed': keys.hasOwnProperty('a') || keys.hasOwnProperty('ArrowLeft')}"
                         class="key key-a"
                    >
                        A&nbsp;/&nbsp;&leftarrow;
                    </div>
                    <div :class="{'pressed': keys.hasOwnProperty('s') || keys.hasOwnProperty('ArrowDown')}"
                         class="key key-s"
                    >
                        S&nbsp;/&nbsp;&downarrow;
                    </div>
                    <div :class="{'pressed': keys.hasOwnProperty('d') || keys.hasOwnProperty('ArrowRight')}"
                         class="key key-d"
                    >
                        D&nbsp;/&nbsp;&rightarrow;
                    </div>
        ...
        <div class="column">
            ...
            <div :class="{'active': pointerLocked}"
                 @click="lockPointer"
                 class="mouse-hints"
                 ref="pointerEventsBase"
                 tabindex="1"
            >
                <div :class="clicks['0'] === true ? 'pressed' : ''"
                     class="mouse-button key"
                >
                    LEFT
                </div>
                <div :class="clicks['2'] === true ? 'pressed' : ''"
                     class="mouse-button key"
                >
                    RIGHT
                </div>
